...
//String build_label = run.getEnvironment().get("BuildID");
String build_label = null;
String subject = null;
...
for (hudson.matrix.MatrixRun run : runs) {		
		...
		build_label = run.getEnvironment().get("build_label");
}
...
<div>
	...
	<table style="padding-left: 20px; padding-right: 20px; padding-top: 25px; width: 100%;">
		<tr>
			<td style="width: 60%">
				<div class="text--title" style="padding-top: 25px;">TruClient CI Replay Test</div>
			</td>
		<td>
			<% if ((total_failed_case == 0) && (total_skipped_case == 0) && (skipping_machines.isEmpty())) {%>
			<div style="padding-left: 10px; "><img align="left" src="${cute_url}"/></div>
			<%} else if ((total_failed_case > 0) || (!skipping_machines.isEmpty())) {%>
			<div style="padding-left: 10px;"><img align="left" src="${fire_url}"/></div>
			<%} else {%>
			<div style="padding-left: 10px;">WARNING</div>
			<%}%>
		</td>
		</tr>
	</table>
		...
		<tbody>
				...
				<td>
					<table border="0" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td>
								<div class="text--hd" style="color: #333333;">Execution Summary</div>
				...
				<td style="padding-top: 10px;">
					<table border="0" cellpadding="0" cellspacing="10" style="width:100%; border: 2px solid #cfd3d6;">
						<tr>
							...
							<td style="border-right: solid 1px #efefef; padding-left: 20px;">
							...
							<td style="padding-left: 20px;">
								<div class="text--md" style="color: #333333;">Online Report Center</div>
								<div class="text--sm"><a class="color--link" href="${online_report_url}">${online_report_url}</a></div>
							</td>
						</tr>
					</table>
				</td>
			...
			<tr>
				<td style="padding-top: 10px; font-size: 14px; font-size: 10pt;">
					<span>TCS Build: <a class="color--link" href="\\\\mydastr01.hpeswlab.net\\products\\TCS\\TCS\\win32_release\\${build_label}">${build_label}</a></span>
			...
			<tr>
				<td style="padding-top: 35px;">						
					<div class="text--hd" style="margin-bottom: 10px; color: #E00000;">Failed Tests</div>
													
					<table border="0" cellpadding="10" cellspacing="0" style="width:100%;">
						<thead class="bgcolor--grey" style="color: #333333;">
							<th>Test Name</th>
							<th>Environment</th> 
							<th>Age</th>
							<th>Details</th>
			...
			<tr>
				<td style="padding-top: 20px;">
					<div class="text--hd" style="color: #333333;">Failed Machines</div>
			...
			<tr>
				<td style="padding-top: 35px;">
					<div class="text--hd" style="margin-bottom: 10px; color: #333333;">Execution Details</div>
										...
										<table cellpadding="0" style="width:100%;">
											<tr>
												...
												<td style="text-align: center; <%= (result.isSkipped() )? 'border-left: solid 1px #f3aa3d;' : 'border-left: solid 1px #da2630;' %>">									
													<div style="color: white; font-weight: bold;">Age${result.getAge()}</div>
												</td>
												<%}%>
											</tr>
										</table>
